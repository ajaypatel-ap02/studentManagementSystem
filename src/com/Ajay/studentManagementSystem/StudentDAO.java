...
public class StudentDAO {
    ...
    public StudentDAO() {
        ...
        if (url == null || user == null || password == null) {
            LOGGER.severe("Database configuration missing. Please set DB_URL, DB_USER, and DB_PASSWORD environment variables.");
     ...
     * @return true if successfully added, false if operation fails
     */
